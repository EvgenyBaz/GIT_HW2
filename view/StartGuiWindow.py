...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_Italy = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButton_Italy.setGeometry(QtCore.QRect(260, 280, 271, 28))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_Italy.setFont(font)
        self.pushButton_Italy.setObjectName("pushButton_Italy")
...
"\n"
"Choose the side!"))
        self.pushButton_Italy.setText(_translate("MainWindow", "Italy"))
