...
class Ui_RusCorpsWindow(object):
    def setupUi(self, RusCorpsWindow):
        ...
        self.aBrgdFirstBatallion = QtWidgets.QComboBox(parent=self.centralwidget)
        self.aBrgdFirstBatallion.setGeometry(QtCore.QRect(70, 110, 191, 22))
        self.aBrgdFirstBatallion.setObjectName("aBrgdFirstBatallion")
        self.aBrgdSecondfirstBatallion = QtWidgets.QComboBox(parent=self.centralwidget)
        self.aBrgdSecondfirstBatallion.setGeometry(QtCore.QRect(70, 130, 191, 22))
        self.aBrgdSecondfirstBatallion.setObjectName("aBrgdSecondfirstBatallion")
        self.aBrgdThirdBatallion = QtWidgets.QComboBox(parent=self.centralwidget)
        self.aBrgdThirdBatallion.setGeometry(QtCore.QRect(70, 150, 191, 22))
        self.aBrgdThirdBatallion.setObjectName("aBrgdThirdBatallion")
        self.aBrgdFourthBatallion = QtWidgets.QComboBox(parent=self.centralwidget)
        self.aBrgdFourthBatallion.setGeometry(QtCore.QRect(70, 170, 191, 22))
        self.aBrgdFourthBatallion.setObjectName("aBrgdFourthBatallion")
        self.aBrgdAdditionalBatallion = QtWidgets.QComboBox(parent=self.centralwidget)
        self.aBrgdAdditionalBatallion.setGeometry(QtCore.QRect(70, 200, 191, 22))
        self.aBrgdAdditionalBatallion.setObjectName("aBrgdAdditionalBatallion")
